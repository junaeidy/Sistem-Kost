<?php 
$pageTitle = $pageTitle ?? 'Buat Review';
$kost = $kost ?? [];
$old = $_SESSION['old'] ?? [];
...
<div class="mb-6">
    ...
    <p class="text-gray-600 mt-1">Berikan penilaian untuk <?= htmlspecialchars($kost['name']) ?></p>
</div>
...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <form action="<?= url('/tenant/review/store/' . $kost['id']) ?>" method="POST">
                    ...
                    <?php for ($i = 1; $i <= 5; $i++): ?>
                        <label class="cursor-pointer">
                            <input type="radio" 
                                   ...
                                   <?= (isset($old['rating']) && $old['rating'] == $i) ? 'checked' : '' ?>>
        ...
        <div class="mb-6">
            ...
            <textarea 
                ...
                placeholder="Ceritakan pengalaman Anda tinggal di kost ini..."><?= htmlspecialchars($old['review_text'] ?? '') ?></textarea>
