<?php
$facilities = !empty($kamar['facilities']) ? json_decode($kamar['facilities'], true) : [];
?>

<div class="max-w-3xl mx-auto">
    <!-- Back Button -->
    <div class="mb-6">
        <a href="<?= url('/owner/kost/' . $kamar['kost_id']) ?>" class="inline-flex items-center text-blue-600 hover:text-blue-800">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-800">Edit Kamar</h2>
            <p class="text-gray-600 mt-1">Kost: <span class="font-semibold"><?= e($kamar['kost_name']) ?></span></p>
        </div>

        <form action="<?= url('/owner/kamar/' . $kamar['id'] . '/update') ?>" method="POST">
            <?= csrf_field() ?>
            ...
            <div class="mb-4">
                ...
                <select id="status" 
                        ...
                        required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    <option value="available" <?= $kamar['status'] == 'available' ? 'selected' : '' ?>>Tersedia</option>
                    <option value="occupied" <?= $kamar['status'] == 'occupied' ? 'selected' : '' ?>>Terisi</option>
            ...
            <div class="flex justify-end space-x-3">
                <a href="<?= url('/owner/kost/' . $kamar['kost_id']) ?>" 
